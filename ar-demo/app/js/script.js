AFRAME.registerComponent("pin", {
    ...
    init: function () {
        ...
        var infotitle = this.infotitle = document.getElementById('infotitle');
        var infodescription = this.infodescription = document.getElementById('infodescription');
